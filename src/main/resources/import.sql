...
INSERT INTO requests (id,name,mark,email,Dest,status,Uid, text, mail) VALUES (100,'Γιάννης', 8, 'john@gmail.com','Βαγγέλης', 'Pending', 'john', 'Συστατική επιστολή για δουλειά', 'company4@gmail.com'); --password: papi
INSERT INTO requests (id,name,mark,email,Dest,status,Uid, text, mail) VALUES (200,'Γιάννης', 7, 'john@gmail.com','Βαγγέλης', 'Pending', 'john','Συστατική επιστολή για μεταπτυχιακό', 'university@gmail.com'); --password: papi
INSERT INTO requests (id,name,mark,email,Dest,status,Uid, text, mail) VALUES (300,'Ελένη', 7, 'eleni@gmail.com','Βαγγέλης', 'Pending', 'eleni','Συστατική επιστολή για εταιρεία', 'company5@hotmail.gr'); --password: papi
